...
function ThemeToggle({ theme, toggleTheme }) {
  ...
  return (
    <button
      ...
      className="relative group inline-block ripple-container p-3.5 rounded-full text-gray-800 dark:text-white flex items-center justify-center cardGradient cursor-pointer transition-colors duration-300 overflow-visible overflow-hidden"
