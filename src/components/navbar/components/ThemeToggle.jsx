...
function ThemeToggle({ theme, toggleTheme }) {
  ...
  return (
    <div className="relative group inline-block overflow-visible">
      ...
      />
      <span
        className={`absolute bottom-full -mb-[5.75rem] left-1/2 transform -translate-x-1/2 px-2 py-1 text-xs border ${styles} rounded-md opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none whitespace-nowrap z-10`}
      >
        {label}
      </span>
    </div>
