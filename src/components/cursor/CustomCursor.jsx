...
//         const size = Math.random() * 6 + 6; // Star size (4px to 10px)
...
//         star.style.color = `hsla(${Math.random() * 360}, 100%, 85%, 1)`;
//         star.style.filter = "drop-shadow(0 0 4px rgba(255, 255, 255, 0.6))";
//         star.innerHTML = "★"; // Star symbol instead of a plain div

//         // Floating effect for fairy dust
...
//         setTimeout(() => star.remove(), 1200); // Remove after fading out
//       }
//     };
