...
function Github({ github, temporary = false}) {
  ...
  return (
    <div
      ...
      from-[#58eba6] via-[#1fc8de] to-[#0584d9] shadow-shadowTwo dark:shadow-shadowOne cursor-pointer"
      onClick={() => window.open(github, "_blank", "noopener,noreferrer")}
    >
      <div className="relative hover:text-white cursor-pointer">
        <div
          className="shadow-md shadow-purple-400 dark:shadow-purple-500 group hover:shadow-none relative w-22 h-12 p-0.5 rounded-full 
          bg-purple-100 dark:bg-purple-800 flex justify-start items-center "
        >
          {/* Website button */}
          <a
            href={github}
            target="_blank"
            rel="noopener noreferrer"
            className="relative z-10 w-12 h-12 rounded-full bg-purple-100 dark:bg-purple-800 flex justify-center items-center focus:outline-none transition duration-200 group"
            aria-label="Website"
          >
          ...
          <div className="relative flex items-center gap-1 text-sm w-fit h-fit pr-4">
