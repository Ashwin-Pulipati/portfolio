...
function Website({ website, temporary = false}) {
  ...
  return (
    ...
    //         target="_blank"
    //         rel="noopener noreferrer"
    //         className="relative z-10 w-12 h-12 rounded-full flex justify-center items-center focus:outline-none transition duration-200 group"
    //         aria-label="Website"
    ...
    >
      <div
        // ② INNER container holds the gradient, padding, click area (and ripple if you add it)
