...
//         className="relative group w-12 h-12 rounded-full cursor-pointer"
...
//                 border border-transparent ${style.hover} cursor-pointer
//                 transition-transform duration-200 hover:scale-110
//               `}
//               >
//                 {icon}
//                 <Tooltip type={type} displayName={displayName} />
//               </div>
//             );
//           })}
//         </div>
        ...
        <div className="flex flex-col items-center gap-1 py-3">
          {sections.map(({ id, displayName, icon, type }) => {
            ...
            return (
              ...
              >
                {/* Tooltip sits outside ripple-container so it's not affected by ripple DOM */}
                {isHovered && <Tooltip type={type} displayName={displayName} />}

                <div
                  onClick={() => onSectionClick(id)}
                  className={`
          flex items-center justify-center p-1.5 rounded-xl ripple-container
          border border-transparent ${style.hover} cursor-pointer
          transition-transform duration-200 hover:scale-110
        `}
                  onMouseDown={createRipple}
