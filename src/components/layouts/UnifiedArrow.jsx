...
const UnifiedArrow = React.memo(
      ...
      return (
        ...
        >
          ...
          <div
            ...
            dark:to-[#1f2022] transition-colors duration-100"
          >
      ...
      return (
        ...
        >
          ...
          <div
            ...
            dark:bg-boxBg bg-gradient-to-br dark:bg-gradient-to-tl from-[#dee3e7] to-white dark:from-[#262a2e]
            dark:to-[#1f2022] group transition-colors duration-100"
          >
  ...
  bg-gradient-to-br from-[#dee3e7] to-white dark:bg-bodyColor dark:bg-none`}
    ...
    shadow-shadowTwo dark:shadow-shadowOne"
          >
            <div className="w-16 h-16 flex justify-center items-center rounded-md bg-gradient-to-br from-[#dee3e7] to-white dark:bg-bodyColor dark:bg-none">
              <Icon />
            </div>
          </div>
        </div>
